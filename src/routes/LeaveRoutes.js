...
LeaveRoutes.get(
  ...
  CheckEmployeeAuth, // 💡 FIXED: Stripped CheckAdminAuth so non-admins don't get a 403 block here
...
LeaveRoutes.post(
  ...
  CheckEmployeeAuth,
  CheckAdminAuth, // Keep this locked; only Admins look at global admin state filters
